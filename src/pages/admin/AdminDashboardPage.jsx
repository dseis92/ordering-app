...
export default function AdminDashboardPage() {
  ...
  // Orders are already in the correct format from database
          ...
          <div className="p-6">
            {loading ? (
              <div className="text-center py-12 text-hilltop-gray">
                <div className="w-12 h-12 border-4 border-hilltop-green border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
                <p>Loading orders...</p>
              </div>
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-hilltop-gray space-y-1">
            ...
            <p className="font-semibold text-hilltop-charcoal">
              {order.order_type.toUpperCase()} • {formatCurrency(order.total)}
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {['received', 'preparing', 'ready', order.order_type === 'delivery' ? 'out_for_delivery' : null, 'completed']
                .filter(Boolean)
                .map((status) => (
                  <button
                    key={status}
